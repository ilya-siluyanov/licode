...
config.nuve.superserviceID = '6615a6f83d635803c29a4c2b'; // default value: ''
config.nuve.superserviceKey = '24421'; // default value: ''
...
config.erizoController.defaultVideoBW = 1000; //default value: 300
config.erizoController.maxVideoBW = 1000; //default value: 300
...
{"presenter": {"publish": true, "subscribe": true, "record": true, "stats": false, "controlhandlers": true},
...
// Use '' to automatically get IP from the interface
config.erizoAgent.publicIP = '51.250.100.5'; //default value: ''
